...
const questions = [
    ...
    { q: "Que fait 'position: sticky' en CSS ?", options: ["Fixe l'élément en haut de la page","Ajuste la transparence" , "Le centre horizontalement", "Le rend collant après un certain défilement"], correct: 3 },
    ...
    { q: "Quelle unité CSS est dépendante de la largeur de la fenêtre ?", options: ["em", "vw","px" , "rem"], correct: 2 },
    { q: "Quelle méthode est la plus efficace pour un site responsive ?", options: ["Tout coder en pixels", "Utiliser Flexbox et Grid", "Utiliser uniquement des media queries", "Utiliser des tableaux HTML"], correct: 2 },
    { q: "Quel est l'élément parent de &lt;th&gt; et &lt;td&gt; dans un tableau HTML ?", options: ["<code>&lt;thead&gt;</code>", "<code>&lt;table&gt;</code>", "<code>&lt;tr&gt;</code>", "<code>&lt;tbody&gt;</code>"], correct: 2 },
    ...
    { q: "Quelle est la différence entre &lt;div&gt; et &lt;span&gt; en HTML ?", options: ["&lt;div&gt; est en ligne, &lt;span&gt; est en bloc", "&lt;div&gt; est pour les liens, &lt;span&gt; pour les titres", "&lt;div&gt; est un élément bloc, &lt;span&gt; est en ligne", "Les deux sont utilisés pour les formulaires"], correct: 0 },
    { q: "A quoi sert la balise &lt;em&gt; en CSS ?", options: ["Met le texte en surbrillance", "Souligne de texte", "Barrer de texte", "Met le texte en italique"], correct: 3 },
    ...
    { q: "Quelle propriété CSS permet d'ajouter une ombre autour des bords d'un élément ?", options: ["text-shadow", "shadow-text", "box-shadow", "font-shadow"], correct: 2 },
    ...
    { q: "Quelle propriété CSS permet de créer une transition fluide entre deux états d'un élément ?", options: ["transform", "animation", "transition", "keyframes"], correct: 2 },
