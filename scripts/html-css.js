...
function changeChapter(chapterId) {
  ...
  let navItem = document.querySelector(
    `.nav-item[onclick="changeChapter('${chapterId}')"]`
  );
  if (navItem) {
...
function visualizeCode1() {
  ...
  if (decodedContent.trim().length === 0) {
    alert(
      "Le champ de code est vide. Veuillez écrire du HTML avant de visualiser."
    );
    return;
  }
...
function divExercice(element) {
  if (
    (element.textContent.trim() === "Écrivez votre code ici") |
    (element.textContent.trim() === "Écrivez votre CSS ici")
  ) {
    element.innerHTML = "";
  }
}
...
document
  ...
  .addEventListener("change", function () {
    ...
    let explanations = {
      static:
        "<strong>Par défaut (static)</strong> : C'est la position normale d'un élément, il est placé selon le flux du document.",
      relative:
        "<strong>Relative</strong> : L'élément est placé normalement, mais on peut le déplacer sans impacter les autres éléments autour.",
      absolute:
        "<strong>Absolute</strong> : L'élément se détache complètement de son emplacement habituel. Elle ne suit plus les autres éléments et se positionne en fonction du premier parent.",
      fixed:
        "<strong>Fixed</strong> : L'élément est positionné par rapport à la fenêtre du navigateur, il reste toujours visible même quand on fait défiler la page.",
      sticky:
        "<strong>Sticky</strong> : L'élément commence comme un élément normal, mais devient fixe lorsqu'on fait défiler la page jusqu'à sa position définie.",
    };
...
const questions = [
  {
    q: "Quel est le rôle du doctype en HTML ?",
    options: [
      "Définir l'encodage",
      "Indiquer la version du document HTML",
      "Ajouter un commentaire",
      "Spécifier le CSS à utiliser",
    ],
    correct: 1,
  },
  {
    q: "Que doit on préciser lorsqu'on utilise l'élément &lt;a&gt; ?",
    options: [
      "Un attribut <code>target=''</code>",
      "Un attribut <code>href=''</code>",
      "Deux attributs <code>href</code> et <code>target</code>",
      "Aucun attribut est obligatoire",
    ],
    correct: 1,
  },
  {
    q: "Quelle est la différence entre &lt;section&gt; et &lt;article&gt; ?",
    options: [
      "Aucune différence",
      "<code>&lt;section&gt</code> est plus générique",
      "<code>&lt;article&gt;</code> est un contenu autonome",
      "<code>&lt;section&gt;</code> doit être utilisé à l'intérieur de <code>&lt;article&gt;</code>",
    ],
    correct: 2,
  },
  {
    q: "Quelle propriété CSS permet de changer la police du texte ?",
    options: ["font-family", "text-style", "font-type", "font-weight"],
    correct: 0,
  },
  {
    q: "Quel mode d'affichage est par défaut pour un élément &lt;span&gt; ?",
    options: ["block", "inline", "flex", "grid"],
    correct: 1,
  },
  {
    q: "Que fait 'position: sticky' en CSS ?",
    options: [
      "Fixe l'élément en haut de la page",
      "Le rend collant après un certain défilement",
  ...
  {
    q: "Quel est l'intérêt des feuilles de style CSS ?",
    options: [
      "Séparer le design du contenu",
      "Structurer le texte",
      "Créer des liens",
      "Ajouter des images",
    ],
  ...
  {
    q: "Quelle unité CSS est dépendante de la largeur de la fenêtre ?",
    options: ["px", "vw", "em", "rem"],
    correct: 1,
  },
  {
    q: "Quelle méthode est la plus efficace pour un site responsive ?",
    options: [
      "Utiliser uniquement des media queries",
      "Utiliser Flexbox et Grid",
      "Tout coder en pixels",
      "Utiliser des tableaux HTML",
    ],
    correct: 1,
  },
  {
    q: "Quel est l'élément parent de &lt;th&gt; et &lt;td&gt; dans un tableau HTML ?",
    options: [
      "<code>&lt;tr&gt;</code>",
      "<code>&lt;table&gt;</code>",
      "<code>&lt;thead&gt;</code>",
  ...
  {
    q: "Quelle pseudo-classe permet de cibler un élément au clique ?",
    options: [
      "<code>:focus</code>",
      "<code>:hover</code>",
      "<code>:checked</code>",
  ...
  {
    q: "Quelle est la meilleure pratique pour améliorer l'accessibilité HTML ?",
    options: [
      "Utiliser uniquement des &lt;div&gt;",
      "Éviter les balises sémantiques",
      "Utiliser des attributs ARIA et des labels",
      "Tout écrire en majuscules",
    ],
    correct: 2,
  },
  {
    q: "Quelle propriété CSS permet de créer une grille de mise en page ?",
    options: [
  ...
  {
    q: "A quoi sert la balise &lt;rem&gt; en CSS ?",
    options: [
  ...
  {
    q: "Quel sélecteur CSS cible tous les paragraphes ?",
    options: ["p", "#p", ".p", "*"],
    correct: 0,
  },
  {
    ...
    options: [
      ...
      "<code>href='_new'</code>",
      "<code>open='newtab'</code>",
    ],
    correct: 0,
  },
  {
    q: "Quelle propriété CSS permet d'ajouter une ombre à un texte ?",
    options: ["text-shadow", "shadow-text", "box-shadow", "font-shadow"],
    correct: 0,
  },
  {
    q: "Quel élément HTML est utilisé pour créer un formulaire ?",
    options: [
      "<code>&lt;form&gt;</code>",
      "<code>&lt;input&gt;</code>",
      "<code>&lt;button&gt;</code>",
  ...
  {
    q: "Quelle propriété CSS permet de contrôler l'espacement entre les lignes de texte ?",
    options: ["letter-spacing", "line-height", "word-spacing", "spacing"],
    correct: 1,
  },
  {
    q: "Que signifie RGB en CSS ?",
    options: [
      "Red Green Blue",
      "Right Grey Black",
      "Random Graphic Blend",
      "Real Gradient Blur",
    ],
    correct: 0,
  },
...
questions.forEach((question, index) => {
  ...
  div.innerHTML = `<br><p class="questions-quiz">${index + 1}. ${
    question.q
  }</p>`;
